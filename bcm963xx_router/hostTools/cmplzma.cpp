...
int main (int argc, char **argv)
{
    ...
    else if (argc == 7 && strcmp(argv[1], "-s") == 0)
    {
    ...
    sprintf(lzmaFile, "%s.lzma", inputBinFile);
    ...
    if (cmpKernel)
    {
        uint32_t  swapedOutLen = htonl(outLen);    //little Endia on build host and big Endia on target
