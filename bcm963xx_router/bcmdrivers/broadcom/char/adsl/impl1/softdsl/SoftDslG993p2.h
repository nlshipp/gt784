 ...
 * $Revision: 1.3 $
 *
 * $Id: SoftDslG993p2.h,v 1.3 2011/05/11 08:28:58 ydu Exp $
 *
...
#define AFE_FE_COMB_A_7_4			(AFE_LD_6302_BITMAP | AFE_FE_ANNEXA_BITMAP | AFE_FE_AVMODE_COMBO_BITMAP | AFE_FE_REV_6302_REV_7_4)
...
/* FIXME: for now, make AnnexJ board also qualified for AnnexM */
#if defined(BCM6368_CHIP)
#define SoftDslAfeIsAnnexM(x) ((((gAfeInfo(x).boardAfeId & AFE_FE_ANNEX_MASK) >> AFE_FE_ANNEX_SHIFT) == AFE_FE_ANNEXM) || SoftDslAfeIsUs0AnnexJ(x))
#else
