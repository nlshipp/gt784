 ...
 *
 * $Id: reg_proto_msg.c,v 1.1 2010/08/05 21:59:03 ywu Exp $
 */
...
reg_msg_m7enr_new()
{
	TlvEsM7Enr *tlv = (TlvEsM7Enr *)malloc(sizeof(TlvEsM7Enr));
...
reg_msg_m7ap_new()
{
	CTlvEsM7Ap *tlv = (CTlvEsM7Ap *)malloc(sizeof(CTlvEsM7Ap));
...
reg_msg_m8ap_new()
{
	CTlvEsM8Ap *tlv = (CTlvEsM8Ap *)malloc(sizeof(CTlvEsM8Ap));
...
void
reg_msg_m8ap_write(CTlvEsM8Ap *t, BufferObj *theBuf, BufferObj *authKey)
{
	LISTITR m_indexItr, m_keyItr;
	LPLISTITR indexItr = NULL, keyItr = NULL;
	CTlvNwKeyIndex *keyIndex;
...
reg_msg_m8sta_new()
{
	CTlvEsM8Sta *tlv = (CTlvEsM8Sta *)malloc(sizeof(CTlvEsM8Sta));
