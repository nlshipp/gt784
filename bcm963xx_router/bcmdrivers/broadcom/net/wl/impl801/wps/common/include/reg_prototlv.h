 ...
 *
 * $Id: reg_prototlv.h,v 1.1 2010/08/05 21:59:02 ywu Exp $
 */
...
#define tlv_find_dserialize(a, b, c, d, f) tlv_find_dserialize_imp(a, b, c, d, f, \
	__FUNCTION__, __LINE__)

tlvbase_s * tlv_new(uint16 theType);
int tlv_allocate_imp(void *v, uint16 theType, int len, const char *func, int line);
