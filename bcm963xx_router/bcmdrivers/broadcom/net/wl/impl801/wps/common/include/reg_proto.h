 ...
 *
 * $Id: reg_proto.h,v 1.1 2010/08/05 21:59:02 ywu Exp $
 */
...
uint32 reg_proto_create_ack(RegData *regInfo, BufferObj *msg);
uint32 reg_proto_create_nack(RegData *regInfo, BufferObj *msg, uint16 configError);
uint32 reg_proto_create_done(RegData *regInfo, BufferObj *msg);
...
uint32 reg_proto_process_done(RegData *regInfo, BufferObj *msg);
