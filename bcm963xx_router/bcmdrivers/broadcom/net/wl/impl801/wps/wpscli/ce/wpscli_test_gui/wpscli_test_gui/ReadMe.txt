================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : wpscli_test_cmd Project Overview
===============================================================================

The application wizard has created this wpscli_test_cmd application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your wpscli_test_cmd application.

wpscli_test_cmd.vcproj
...
wpscli_test_cmd.h
    ...
    project specific headers and declares the Cwpscli_test_cmdApp application class.

wpscli_test_cmd.cpp
    This is the main application source file that contains the application
    class Cwpscli_test_cmdApp.


wpscli_test_cmdppc.rc
...
res\wpscli_test_cmdppc.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.


res\wpscli_test_cmd.ico
...
wpscli_test_cmdDlg.h, wpscli_test_cmdDlg.cpp - the dialog
    These files contain your Cwpscli_test_cmdDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named wpscli_test_cmd.pch and a precompiled types file named StdAfx.obj.
