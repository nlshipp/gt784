 ...
 *
 * $Id: linux_osl.c,v 1.1 2010/08/05 21:59:00 ywu Exp $
 */
...
#if ((defined(WLC_HIGH) && !defined(WLC_LOW)) && (defined(BCM_RPC_NOCOPY) || \
	defined(BCM_RPC_RXNOCOPY)))
#define CTFPOOL_SPINLOCK
#endif
...
{
	if (((struct sk_buff *)skb)->recycle_hook && (((struct sk_buff *)skb)->recycle_flags & SKB_DATA_RECYCLE)) {
		osh->pub.pktbuffered++;
	}
}
