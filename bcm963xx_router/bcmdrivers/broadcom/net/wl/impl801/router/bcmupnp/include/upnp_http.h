/*
 * Broadcom UPnP module HTTP protocol include file
 *
 ...
 *
 * $Id: upnp_http.h,v 1.1 2010/08/05 21:58:59 ywu Exp $
 */
 ...
 * Functions
 */
int upnp_http_fsm_init(UPNP_CONTEXT *, struct upnp_method *);
...
int upnp_http_fsm_dispatch(UPNP_CONTEXT *, struct upnp_method *);
int upnp_http_fsm_engine(UPNP_CONTEXT *, struct upnp_state *);
