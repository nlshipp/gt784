 ...
 *
 * $Id: soap_x_wanipconnection.c,v 1.1 2010/08/05 21:58:59 ywu Exp $
 */
#include <upnp.h>
...
)
{
	...
	strcpy(UPNP_STR(value), igd_ctrl->wan_up ? "Connected" : "Disconnected");
	return OK;
}
/* >> AUTO GENERATED FUNCTION */
...
)
{
	...
	UPNP_UI4(value) = igd_ctrl->wan_up_time;
	return OK;
}
/* >> AUTO GENERATED FUNCTION */
...
)
{
	...
	strcpy(UPNP_STR(value), inet_ntoa(igd_ctrl->wan_ip));
	return OK;
}
/* >> AUTO GENERATED FUNCTION */
