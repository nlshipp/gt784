 ...
 *
 * $Id: soap_x_layer3forwarding.c,v 1.1 2010/08/05 21:58:59 ywu Exp $
 */
#include <upnp.h>
...
)
{
	...
	return statevar_DefaultConnectionService(context, service, out_NewDefaultConnectionService->statevar, ARG_VALUE(out_NewDefaultConnectionService));
}
/* >> AUTO GENERATED FUNCTION */
