 ...
 *
 * $Id: nas.h,v 1.1 2010/08/05 21:58:59 ywu Exp $
 */
...
extern void eapol_dispatch(nas_t *nas, eapol_header_t *eapol);
#ifdef BCMSUPPL
...
extern void preauth_dispatch(nas_t *nas, eapol_header_t *eapol);
#endif /* BCMWPA2 */
...
#define STA_DEAUTH_DELAY	1	/* delay in second before call wl ioctl deauth */
...
#else
#define CHECK_NAS(mode) ((mode) & (WPA | WPA_PSK))
#define CHECK_PSK(mode) ((mode) & WPA_PSK)
#define CHECK_RADIUS(mode) ((mode) & (WPA | RADIUS))
#define CHECK_WPA(mode) ((mode) & WPA)
#define CHECK_AUTH(mode) ((mode) & (RADIUS | WPA | WPA_PSK))
#endif /* BCMWPA2 */
