 ...
 *
 * $Id: nas_wl.c,v 1.1 2010/08/05 21:58:59 ywu Exp $
 */
...
int
nas_set_key(nas_t *nas, struct ether_addr *ea, uint8 *key, int len, int index, int tx)
{
	wl_wsec_key_t wep;
#ifdef BCMDBG
