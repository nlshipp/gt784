 ...
 *
 * $Id: wlc_pio.h,v 1.1 2010/08/05 21:59:02 ywu Exp $
 */
#ifndef _wlc_pio_h_
#define _wlc_pio_h_
...
#ifdef WLPIO
extern pio_t* wlc_pio_attach(wlc_pub_t *pub, struct wlc_info *wlc, uint fifo, uint16 *mhf2);
...
#define wlc_pio_attach(pub, wlc, fifo, mhf2)	(NULL)
