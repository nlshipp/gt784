 ...
 *
 * $Id: wlc_rate.c,v 1.1 2010/08/05 21:59:02 ywu Exp $
 */
...
#ifdef WL11N
void
wlc_rateset_mcs_upd(wlc_rateset_t *rs, uint8 txstreams)
{
	int i;
...
ratespec_t
wlc_compute_rspec(d11rxhdr_t *rxh, uint8 *plcp, uint16 phy_type)
{
	ratespec_t rspec = PHY_TXC1_BW_20MHZ << RSPEC_BW_SHIFT;

#ifdef WL11N
	if ((phy_type == PHY_TYPE_N) || (phy_type == PHY_TYPE_SSN) || phy_type == PHY_TYPE_HT) {
...
void
wlc_rateset_mcs_build(wlc_rateset_t *rateset, uint8 txstreams)
{
