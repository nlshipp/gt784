 ...
 *
 * $Id: wlc_mfg.c,v 1.1 2010/08/05 21:59:02 ywu Exp $
 */
#ifndef WLTEST
...
BCMATTACHFN(wlc_mfg_attach)(wlc_pub_t *pub, wlc_info_t *wlc)
{
	...
	/* register module */
	if (wlc_module_register(pub, mfg_iovars, "mfg", info, wlc_mfg_doiovar, NULL, NULL)) {
...
{
	mfg_info_t *info = (mfg_info_t *)hdl;
	int err = 0;
	int32 int_val;
	int32 *ret_int_ptr = (int32 *)arg;

	if ((err = wlc_iovar_check(info->pub, vi, arg, len, IOV_ISSET(actionid))) != 0)
		return err;
