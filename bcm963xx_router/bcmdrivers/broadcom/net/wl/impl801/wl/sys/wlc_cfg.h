 ...
 *
 * $Id: wlc_cfg.h,v 1.1 2010/08/05 21:59:01 ywu Exp $
 */
...
#define D11_DEFAULT	0x7fffffb0	/* Supported  D11 revs: 4, 5, 7-28, 29, 30
...
#define GPHY_DEFAULT	0x000003c6	/* Supported gphy revs:
					 ...
					 *	9	4311b0
					 */
#define NPHY_DEFAULT	0x000103ff	/* Supported nphy revs:
					 *	0	4321a0
					 *	1	4321a1
					 *	2	4321b0/b1/c0/c1
					 *	3	4322a0
...
#define WLNOKIA_ENAB(wlc_pub)	1
#else /* WLLMAC_ONLY */
#define LMAC_ENAB(wlc_pub)	(wlc_pub->_lmac)
#define WLNOKIA_ENAB(wlc_pub)	(wlc_pub->_nokia)
#endif /* WLLMAC_ONLY */
#else /* WLLMAC */
