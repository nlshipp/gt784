 ...
 *
 * $Id: wl_dbg.h,v 1.1 2010/08/05 21:59:01 ywu Exp $
 */
...
#define	WL_SPARE6(args)		do {if (wl_msg_level2 & WL_ACI_VAL) printf args;} while (0)
...
#define WL_CHANINT(args)	do {if (wl_msg_level2 & WL_CHANINT_VAL) printf args;} while (0)
#define WL_SPARE7(args)		do {if (wl_msg_level2 & WL_THERMAL_VAL) printf args;} while (0)
#define WL_P2P(args)		do {if (wl_msg_level2 & WL_P2P_VAL) printf args;} while (0)
