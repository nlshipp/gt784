 ...
 *
 * $Id: wlc_extlog.c,v 1.1 2010/08/05 21:59:02 ywu Exp $
 */
...
BCMATTACHFN(wlc_extlog_attach)(osl_t *osh, wlc_info_t *wlc)
{
	...
	/* register module */
	if (wlc_module_register((wlc_pub_t*)wlc->pub, extlog_iovars, "extlog", log_info,
		wlc_extlog_doiovar, NULL, NULL)) {
	...
	void *params, uint p_len, void *arg, int len, int val_size, struct wlc_if *wlcif)
{
	...
	if ((err = wlc_iovar_check(extlog->wlc->pub, vi, arg, len, IOV_ISSET(actionid))) != 0)
		return err;
