 ...
 *
 * $Id: wlc_scb.h,v 1.1 2010/08/05 21:59:02 ywu Exp $
 */
...
#endif
#ifdef BCMDBG
	uint16	_dbgid;	/* A unique debug id that verifies validity of scb pointer in pkttag */
#endif
...
wlc_pkttag_scb_get(void *p)
{
	...
	scb = WLPKTTAG(p)->_scb;
#ifdef BCMDBG
	ASSERT(SCB_ISVALID(scb, WLPKTTAG(p)->_scb_dbgid));
#endif
	return scb;
}
