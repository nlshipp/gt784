 ...
 *
 * $Id: wlc_phy_shim.h,v 1.1 2010/08/05 21:59:02 ywu Exp $
 */
...
extern struct wl_delayed_task * wlapi_init_delayed_task(wlc_phy_shim_info_t *physhim, void (*fn)(void* arg), void *arg);
extern void wlapi_free_delayed_task(wlc_phy_shim_info_t *physhim, struct wl_delayed_task *task);
extern void wlapi_schedule_delayed_task(struct wl_delayed_task *task, uint delay);
extern bool wlapi_cancel_delayed_task(struct wl_delayed_task *task);
...
extern void wlapi_bmac_pktengtx(wlc_phy_shim_info_t *physhim, wl_pkteng_t *pkteng, uint8 rate,
