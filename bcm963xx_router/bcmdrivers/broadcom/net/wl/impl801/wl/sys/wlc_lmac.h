 ...
 *
 * $Id: wlc_lmac.h,v 1.1 2010/08/05 21:59:02 ywu Exp $: wlc_lmac.h
 */
...
extern void wlc_lmac_rx_sendup(lmac_info_t *lmac, void *p, d11rxhdr_t *rxh,
...
extern int  wlc_up_lmac(lmac_info_t *lmac);
extern int wlc_down_lmac(lmac_info_t *lmac);
extern uint16 wlc_lmac_recvfilter(lmac_info_t *lmac, struct dot11_header *h,
	d11rxhdr_t *rxh, struct scb **pscb);
extern void wlc_lmac_recvctl(lmac_info_t *lmac, osl_t *osh, d11rxhdr_t *rxh, void *p);
...
extern int
wlc_ioctl_lmac(lmac_info_t *lmac, int cmd, void *arg, int len, struct wlc_if  *wlcif);
