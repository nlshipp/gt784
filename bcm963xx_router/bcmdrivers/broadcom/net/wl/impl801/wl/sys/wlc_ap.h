 ...
 *
 * $Id: wlc_ap.h,v 1.1 2010/08/05 21:59:01 ywu Exp $
 */
#ifndef _WLC_AP_H_
#define _WLC_AP_H_
...
struct wlc_ap_info {
	...
	wme_param_ie_t	wme_param_ie_ap;		/* WME parameters in use locally by AP */
...
#ifdef AP
extern wlc_ap_info_t* wlc_ap_attach(wlc_pub_t *pub, wlc_info_t *wlc);
extern void wlc_ap_detach(wlc_ap_info_t *ap);
extern void wlc_ap_up(wlc_ap_info_t *apinfo, wlc_bsscfg_t *bsscfg);
extern int wlc_ap_down(wlc_ap_info_t *apinfo, wlc_bsscfg_t *bsscfg);
extern int wlc_ap_ioctl(wlc_ap_info_t *ap, int cmd, void *arg, int len, struct wlc_if *wlcif);
...
extern void wlc_authresp_ap(wlc_ap_info_t *ap, wlc_bsscfg_t *bsscfg,
                            d11rxhdr_t *rxh,
                            struct dot11_management_header *hdr,
                            void *body, uint len);
extern void wlc_wme_setup_req(wlc_ap_info_t *ap, struct dot11_management_header *hdr, uint8 *body,
	int body_len);
extern void wlc_probe_response(wlc_ap_info_t *ap, d11rxhdr_t *rxh, uint8 *plcp,
...
extern void wlc_process_assocreq(wlc_ap_info_t *ap, wlc_bsscfg_t *bsscfg, d11rxhdr_t *rxh,
...
extern int wlc_ap_switch_channel(wlc_bsscfg_t *bsscfg, chanspec_t chanspec,
                                 uint8 mode, uint8 count, uint8 reg_class);
extern int wlc_ap_apply_channel_switch(wlc_bsscfg_t *bsscfg);

#ifdef WL11N
extern bool wlc_ht_ap_coex_tea_chk(wlc_info_t *wlc, ht_cap_ie_t *cap_ie);
extern bool wlc_ht_ap_coex_ted_chk(wlc_info_t *wlc, bcm_tlv_t *tlv, uint8);
extern void wlc_ht_coex_switch_bw(wlc_info_t *wlc, bool downgrade, uint8 rc);
extern void wlc_ht_coex_update_fid_time(wlc_info_t *wlc);
extern void wlc_ht_coex_update_permit(wlc_info_t *wlc, bool permit);
extern void wlc_ht_ap_coex_tebc_proc(wlc_info_t *wlc);
extern void wlc_switch_ab_11n(wlc_info_t *wlc, bool ab, bool init);
#endif /* WL11N */

#ifdef RADAR
extern void wlc_set_dfs_cacstate(wlc_ap_info_t *ap, int state);
extern void wlc_dfs_timer_add(wlc_ap_info_t *ap);
extern void wlc_set_dfs_cacstate(wlc_ap_info_t *ap, int state);
extern void wlc_dfs_setchanspec(wlc_ap_info_t *ap, chanspec_t chanspec);
#endif /* RADAR */
...
#define wlc_ap_attach(a, b) (wlc_ap_info_t *)(uintptr)0xdeadc0de
#define wlc_ap_detach(a) do {} while (0)
#define wlc_ap_up(a, b) do {} while (0)
#define wlc_ap_down(a, b) 0
#define wlc_ap_ioctl(a, b, c, d, e) BCME_UNSUPPORTED
...
#define wlc_authresp_ap(a, b, c, d, e, f) do {} while (0)
#define wlc_wme_setup_req(a, b, c, d) do {} while (0)
#define wlc_probe_response(a, b, c, d, e, f) do {} while (0)
#define wlc_eapol_event(a, b, c, d) do {} while (0)
#define wlc_wpa_set_cap(a, b, c, d) 0
#define wlc_process_assocreq(a, b, c, d, e, f, g) do {} while (0)
...
#ifdef RADAR
#define wlc_set_dfs_cacstate(a, b) do {} while (0)
#define wlc_dfs_timer_add(a) do {} while (0)
#define wlc_dfs_setchanspec(a, b) do {} while (0)
#endif /* RADAR */
...
extern void wlc_read_pmq_ea(wlc_ap_info_t *wlc,  struct ether_addr* eaddr);
extern void wlc_bss_up(wlc_ap_info_t *ap, wlc_bsscfg_t *bsscfg, char *bcn, int len);
extern bool wlc_prq_process(wlc_info_t *wlc, bool bounded);

#if defined(WL_AP_TPC)
extern void wlc_ap_tpc(wlc_info_t *wlc);
#endif /* WL_AP_TPC */
