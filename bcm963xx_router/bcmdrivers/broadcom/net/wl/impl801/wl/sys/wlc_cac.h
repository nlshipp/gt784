 ...
 *
 * $Id: wlc_cac.h,v 1.1 2010/08/05 21:59:01 ywu Exp $
 */
...
extern void wlc_cac_txflowcontrol(wlc_cac_t *cac, bool state, uint8 ac);
#ifdef BCMDBG
extern int wlc_dump_cac(wlc_cac_t *cac, struct bcmstrbuf *b);
#endif /* BCMDBG */
void wlc_cac_on_join_bss(wlc_cac_t *cac, struct ether_addr *bssid, bool roam);
...
void wlc_frameaction_cac(uint action_id, wlc_cac_t *cac,
...
#define wlc_cac_is_traffic_admitted(a, b, c) (1)
...
#define wlc_cac_txflowcontrol(a, b, c) do {} while (0)
#define wlc_cac_on_leave_bss(a)	do {} while (0)
#define wlc_frameaction_cac(a, b, c, d, e) do {} while (0)
#endif  /* WLCAC */
