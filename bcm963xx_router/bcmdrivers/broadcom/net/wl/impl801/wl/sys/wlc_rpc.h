 ...
 *
 * $Id: wlc_rpc.h,v 1.1 2010/08/05 21:59:02 ywu Exp $
 */
...
_wlc_rpc_id_lookup(const struct name_entry* tbl, int _id)
{
...
void txstatus2rpc_txstatus(tx_status_t *txstatus, wlc_rpc_txstatus_t *rpc_txstatus)
{
	...
	rpc_txstatus->status_frameid = (txstatus->status << 16) | txstatus->frameid;
	rpc_txstatus->sequence_lasttxtime = (txstatus->sequence << 16) | txstatus->lasttxtime;
