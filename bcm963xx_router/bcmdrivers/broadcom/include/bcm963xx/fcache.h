...
#if (FCACHE_HTABLE_SIZE > 1024)              /* CAUTION: Blog_t uint8_t hash  */
#error "Invalid hash tables size, DO NOT EXCEED 1024"
#endif
#if (FCACHE_MAX_ENTRIES > 4096)              /* CAUTION: Flow_t uint8_t self  */
