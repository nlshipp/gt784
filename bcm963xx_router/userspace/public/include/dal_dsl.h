...
CmsRet dalDsl_setDslBonding(int enable,int dsldatapump);
#else
...
CmsRet dalDsl_setDslBondingAutodetect(int enable);
CmsRet dalDsl_getDslBondingAutodetect(int *enable);
#endif

#if defined(AEI_VDSL_TOGGLE_DATAPUMP)
CmsRet dalDsl_setDslDatapumpAutodetect(int enable);
CmsRet dalDsl_getDslDatapumpAutodetect(int *enable);
#endif
