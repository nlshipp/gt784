...
void cmsTmr_WlanBatchcancel(void *handle, CmsEventHandler func, const char *name)
{
   CmsTimerHandle *tmrHandle = (CmsTimerHandle *) handle;
   CmsTimerEvent *currEvent, *prevEvent;
...
/*check exist DMZ status timer*/
UBOOL8 cmsTmr_isDMZStatusTimerEventPresent(const void *handle, CmsEventHandler func)
{
   const CmsTimerHandle *tmrHandle = (const CmsTimerHandle *) handle;
   CmsTimerEvent *tmrEvent;
   UBOOL8 found=FALSE;
...
/* cancel dmz status timer*/
void cmsTmr_DMZStatusTimercancel(void *handle, CmsEventHandler func, const char *name)
{
   CmsTimerHandle *tmrHandle = (CmsTimerHandle *) handle;
   CmsTimerEvent *currEvent, *prevEvent;
